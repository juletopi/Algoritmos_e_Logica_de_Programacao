    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            else
            {
                if (media <= 7)
                {
                    Console.WriteLine("O aluno está de EXAME FINAL, a média do aluno foi de: " +media);
                    Console.WriteLine("Caso já feito o EXAME FINAL, informe a nota tirada pelo aluno:");
                ...
                if (exame_final >= 5)
                {
                    Console.WriteLine("A média do aluno foi de: " +exame_final);
                    Console.WriteLine("O aluno foi APROVADO!");
                }
                else
                {
